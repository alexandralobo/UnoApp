...
namespace API.Migrations
{
    ...
    [Migration("20220315163815_Created LoginUser & changed Guest")]
    partial class CreatedLoginUserchangedGuest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.GameLobby", b =>
                {
                    ...
                    b.Property<string>("PickedColour")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("API.Entities.LoginUserRole", b =>
                {
            ...
            modelBuilder.Entity("API.Entities.LoginUserRole", b =>
                {
                    b.HasOne("API.Entities.LoginUser", "LoginUser")
                        .WithMany()
                    ...
                    b.HasOne("API.Entities.AppRole", "Role")
                        .WithMany("LoginUserRoles")
                        .HasForeignKey("RoleId1");

                    b.HasOne("API.Entities.LoginUser", null)
                        .WithMany()
